                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            <div class="contact-card card h-100">
                                ...
                                <div class="card-body p-0">
                                    <div class="contact-item d-flex align-items-center px-3 py-3">
                                        <div class="contact-avatar me-3" style="background: #dc3545;">ML</div>
                                        <div class="flex-grow-1">
                                            <div class="contact-name">M Mansoor Lohawala</div>
                                            <div class="contact-number">+91 6300 428153</div>
                                        </div>
                                        <a href="https://wa.me/916300428153" target="_blank" class="wa-btn" title="Open WhatsApp">
                                            <i class="bi bi-whatsapp"></i>
                                        </a>
                                    </div>
                                    <div class="contact-item d-flex align-items-center px-3 py-3">
                                        <div class="contact-avatar me-3" style="background: #dc3545;">MB</div>
                                        <div class="flex-grow-1">
                                            <div class="contact-name">M Mustafa Badri</div>
                                            <div class="contact-number">+91 77424 17906</div>
                                        </div>
                                        <a href="https://wa.me/917742417906" target="_blank" class="wa-btn" title="Open WhatsApp">
                                            <i class="bi bi-whatsapp"></i>
                                        </a>
                                    </div>
                                    <div class="contact-item d-flex align-items-center px-3 py-3">
