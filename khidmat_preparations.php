...
// Fetch categories
$query = "SELECT *, CASE WHEN category_name_ld IS NOT NULL AND category_name_ld != '' THEN CONCAT(category_name, ' / ', category_name_ld) ELSE category_name END AS display_name FROM `bqi_categories` WHERE `category_type` = 'preparation' AND `is_active` = 1 ORDER BY `sort_order`, `category_name`";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-outline-info edit-btn"
                                                    ...
                                                    data-description="<?= htmlspecialchars($r['description_text']) ?>"
