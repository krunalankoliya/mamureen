                        ...
                        <table class="table table-striped" id="datatable_training">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $i + 1 ?></td>
                                        <td><?php echo htmlspecialchars($r['program_type']) ?></td>
                                        ...
                                        <td><?php echo $r['duration_minutes'] ?></td>
                                        <td><?php echo $r['attendee_count'] ?></td>
                                        <td><?php echo htmlspecialchars($r['jamaat'] ?? '') ?></td>
                                        <td><?php echo htmlspecialchars($r['submitted_by'] ?? $r['user_its']) ?></td>
                                        <td style="display:none"><?php echo htmlspecialchars($r['description'] ?? '') ?></td>
                                        <td style="display:none"><?php echo htmlspecialchars($r['user_its'] ?? '') ?></td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline-primary view-btn"
                                                data-title="<?php echo htmlspecialchars($r['program_type']) ?>"
