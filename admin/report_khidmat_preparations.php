            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="datatable_khidmat_prep">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Category</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td data-full="<?= htmlspecialchars($r['description_text'] ?? '') ?>"><?= htmlspecialchars(mb_strimwidth($r['description_text'] ?? '', 0, 60, '…')) ?></td>
