                                        ...
                                        <div class="row pt-2">
                                            <div class="col-md-12 d-flex">
                                                ...
                                                <div class="fetch_name">
                                                    <h5 class="card-title pt-2 pb-0"><?php echo htmlspecialchars($userdata['full_name_en']) ?></h5>
                                                    <h5 class="card-title pt-2 pb-0">
                                                        ITS ID: <?php echo htmlspecialchars($userdata['its_id']) ?>
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <form method="post" id="myForm" onsubmit="return validateForm()">
                                <div class="row">
                                    <?php if ($userdata): ?>
                                        ...
                                        <input type="hidden" name="valid_its" value="<?php echo htmlspecialchars($userdata['its_id']) ?>">
                                        <input type="hidden" name="full_name_en" value="<?php echo htmlspecialchars($userdata['full_name_en']) ?>">
                                        <input type="hidden" name="gender" value="<?php echo htmlspecialchars($userdata['gender']) ?>">
                                        <input type="hidden" name="jamaat" value="<?php echo htmlspecialchars($userdata['jamaat']) ?>">
                                        <input type="hidden" name="jamiat" value="<?php echo htmlspecialchars($userdata['jamiat']) ?>">
                                        <input type="hidden" name="mobile" value="<?php echo htmlspecialchars($userdata['mobile'] ?? '') ?>">
                                        <input type="hidden" name="email" value="<?php echo htmlspecialchars($userdata['email'] ?? '') ?>">
                                        <input type="hidden" name="dob" value="<?php echo htmlspecialchars($userdata['dob'] ?? '') ?>">
                                    <?php endif; ?>

                                    <?php if ($lddata): ?>
                                        <!-- Hidden fields for editing existing record -->
                                        <input type="hidden" name="its_id" value="<?php echo htmlspecialchars($lddata['its_id']) ?>">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" value="<?php echo htmlspecialchars($lddata['its_id']) ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" value="<?php echo htmlspecialchars($lddata['full_name']) ?>" readonly>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="d-grid gap-2">
                                            <button class="btn btn-primary" name="submit" type="submit"
                                                    <?php echo (! $userdata && ! $lddata) ? 'disabled' : '' ?>>Submit</button>
                                        </div>
                                    </div>
