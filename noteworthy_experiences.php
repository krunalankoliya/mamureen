                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea name="experience_text" class="form-control" style="height: 150px;" placeholder="Describe the noteworthy experience..." required></textarea>
                                            </div>
                                        </div>
            ...
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="experience_text" id="edit_experience" class="form-control" style="height: 180px;" required></textarea>
                    </div>
                </div>
