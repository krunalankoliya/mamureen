                                                            ...
                                                            <tbody>
                                                                <?php foreach ($userdata_list as $index => $user): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <img src="<?= user_photo_url($user['its_id']) ?>"
                        ...
                        <div class="col-md-12 mt-4">
                            ...
                            <ul class="nav nav-tabs" id="hifzTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link <?php echo ($active_tab === 'your_entries') ? 'active' : '' ?>" id="your-entries-tab" data-bs-toggle="tab" data-bs-target="#your-entries"
                                        type="button" role="tab" aria-controls="your-entries" aria-selected="true">
                                        Your Entries
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link <?php echo ($active_tab === 'mauze_entries') ? 'active' : '' ?>" id="mauze-entries-tab" data-bs-toggle="tab" data-bs-target="#mauze-entries"
                                        ...
                                        <tbody>
                                            <?php foreach ($data as $student): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="certificates.php?its_id=<?php echo $student['its_id'] ?>&gender=<?php echo $student['gender'] ?>&name=<?php echo urlencode($student['full_name_ar']) ?>"
